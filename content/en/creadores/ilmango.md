...
{{< canle ancho="24px" alto="24px" tipo="youtube" titulo="Youtube" ligazon="UCgywV9GRFh9sIDRRlH2KJ9A" >}}
...
{{< canle ancho="24px" alto="24px" tipo="twitch" titulo="Twitch" ligazon="ilmango" >}}
